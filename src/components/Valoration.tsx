	...
	return (
		<div className="bg-primary h-[400px] w-full flex items-center text-background justify-center flex-col">
				...
				<p className="flex items-center">
					...
					<span className="ml-2">
						<a
							...
							href="https://www.facebook.com/share/1YCUtx2Xmq/"
						>
							Facebook
						</a>
					</span>
				...
				<p className="flex items-center mt-2">
					...
					<span className="ml-2">
						<a
							...
							href="https://www.instagram.com/dr.faustinocirujanop/"
						>
							Instagram
						</a>
					</span>
			...
			<div className="flex gap-4 h-14 mt-4">
				<button
					className="bg-background text-primary w-40 text-sm"
					onClick={scrollToContact}
				>
					AGENDAR
				</button>
        <button className="w-40 text-sm bg-primary border-background border-3 hover:border-accent">
				<a
					className="text-background hover:text-background"
					href="mailto:faustinorc@gmail.com"
				>
					ENVIAR CORREO
				</a>
